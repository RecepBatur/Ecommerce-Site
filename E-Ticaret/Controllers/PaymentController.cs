...
namespace E_Ticaret.Controllers
{
    public class PaymentController : Controller
    {
        ...
        public PaymentController(eTicaretContext context)
        {
            _context = context;
        }
        public void CheckLogin()
        {
            ...
            if (customerId == null) //customerId'si yoksa yani login olmamış.
            {
        ...
        {
            var eTicaretContext = _context.PaymentMethods;
        ...
        {
            /*Request.HttpContext.Connection.RemoteIpAddress.ToString();*/ //checkout requesti hangi IpAdressi çağırdı. Kim checkout'a ulaşmaya çalışıyor.
            ...
            //Ödeme kutususuna gönder ve onay al...
            //onay geldiyse
            {
        ...
        public async Task<IActionResult> Create([Bind("OrderId,TimeStamp,Price,AllDelivered,Cancelled,PaymentMethodId,PaymentComplete,CustomerId")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("OrderId,TimeStamp,Price,AllDelivered,Cancelled,PaymentMethodId,PaymentComplete,CustomerId")] Order order)
        {
            if (id != order.OrderId)
            {
                return NotFound();
        ...
        public async Task<IActionResult> DeleteConfirmed(long id)
        {
            ...
            {
                return Problem("Entity set 'eTicaretContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
