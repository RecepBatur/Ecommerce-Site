...
namespace E_Ticaret.Areas.Admin.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public Product? Product(long id)
        {
            ...
            .Include(p => p.Seller).FirstOrDefault(m => m.ProductId == id);
        ...
        //public async Task<IActionResult> Create([Bind("ProductId,ProductName,ProductPrice,Description,ProductRate,CategoryId,IsDeleted,BrandId,SellerId")] Product product)
        //{
